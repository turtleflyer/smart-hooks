...
const siblingsCanCommunicate = imports => () => {
  const {
    CanUpdate, CanListen, render, getLastMaps,
  } = imports;
  const subscribeId = '1';
...
const sophisticatedStructure = imports => () => {
  const {
    render, getLastMaps, CanListen, CanUpdate, CanListenAndUpdate,
  } = imports;
